...
export declare function connectAnchor(docId?: string, sidenoteId?: string, element?: string | HTMLElement): AppThunk<void>;
...
export declare function selectAnchor(docId?: string, anchor?: string | HTMLElement | null): AppThunk<void>;
export declare function disconnectSidenote(docId?: string, sidenoteId?: string): AppThunk<void>;
export declare function disconnectAnchor(docId?: string, anchor?: string | HTMLElement | null): AppThunk<void>;
export declare function resetAllSidenotes(): AppThunk<void>;
export declare function disableNextDeselectSidenote(): void;
export declare function deselectSidenote(docId: string): AppThunk;
